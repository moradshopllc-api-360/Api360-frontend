  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          // Enhanced background and text colors for better visibility
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        // Enhanced focus and hover states with better contrast
        ...
        "dark:text-card-foreground dark:hover:bg-accent/50",
        className
      )}
      {...props}
    >
